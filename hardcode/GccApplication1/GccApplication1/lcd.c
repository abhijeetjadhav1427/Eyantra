...
* Example call: lcd_wr_command("xyz");
*
*/
...
* Example call: lcd_string("hello world");
*
*/
...
* input: row no. and coloumn no. of the lcd 
* output: no return
* logic: Position the LCD cursor at "row", "column"
* Example call: lcd_cursor(1,2); // set cursor at first row and second coloumn
*
*/
...
* input: row no. and coloumn no. of the lcd
* output: no return
* logic: Function to print any input value up to the desired digit on LCD
* Example call: lcd_print(1,2,3,1); //It prints the one digit value 2 at first row and second cloumn of the lcd
*
*/
